        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stat) => (
            <div key={stat.label}>
              ...
              <p className="leading-7 font-montserrat text-slate-bold ">{stat.label}</p> 
            </div>
          ))} 
        </div>
      </div>

      <div className="relative flex-1 flex justify-center items-center xm:min-h-screem max-xl:py -40 bg-primary bg-hero">
        <img 
        src={bigShoe1} 
        alt="shoe collection" 
        width={610}
